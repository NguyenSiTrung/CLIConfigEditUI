...
export function Sidebar({ onToolSelect, onAddCustomTool, onEditCustomTool, onDeleteCustomTool }: SidebarProps) {
  const {
    activeToolId,
    searchQuery,
    setSearchQuery,
...
function ToolSection({ title, tools, activeId, onSelect, dimmed, defaultExpanded = true }: ToolSectionProps) {
